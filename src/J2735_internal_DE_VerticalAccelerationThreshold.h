...
#define J2735_INTERNAL_BIT_VERTICAL_ACCELERATION_THRESHOLD_LEFT_REAR    2U
#define J2735_INTERNAL_BIT_VERTICAL_ACCELERATION_THRESHOLD_RIGHT_FRONT  3U
#define J2735_INTERNAL_BIT_VERTICAL_ACCELERATION_THRESHOLD_RIGHT_REAR   4U
...
/**
 * @internal
 * @brief Read 5 bits from buffer for VerticalAccelerationThreshold.
 *
 * This is the ONLY macro that performs I/O (calls J2735_READ_BITS) for
 * VerticalAccelerationThreshold. All other macros operate purely on the 5-bit value returned by
 * this macro.
 *
 * @param[in] buf Pointer to UPER-encoded VerticalAccelerationThreshold (const uint8_t*).
 ...
 * @pre @p buf must be aligned to the start of the VerticalAccelerationThreshold encoding.
...
/**
 * @internal
 * @brief Extension check for non-extensible VerticalAccelerationThreshold.
 *
 ...
 * @note Internal use only.
 */
#define J2735_INTERNAL_IS_EXTENSION_VERTICAL_ACCELERATION_THRESHOLD(raw5) (0U)
 ...
 * @note Internal use only. Use J2735_VERTICAL_ACCELERATION_THRESHOLD_GET_*() accessors for public
 * API.
 */
#define J2735_INTERNAL_GET_ONE_VERTICAL_ACCELERATION_THRESHOLD(raw5, bit_pos)                      \
 ...
 *
 * @param[in] buf Pointer to the start of the VerticalAccelerationThreshold UPER encoding (const
 * uint8_t*).
 ...
 *
 * VerticalAccelerationThreshold is a fixed-size BIT STRING, always 5 bits on wire.
 *
 * @param[in] buf Pointer to the start of the VerticalAccelerationThreshold UPER encoding (const
 * uint8_t*).
 * @return Always 5U.
 ...
 * @param[in] buf Pointer to the start of the VerticalAccelerationThreshold UPER encoding (const
 * uint8_t*).
 * @pre @p buf must point to valid VerticalAccelerationThreshold encoding with +7 byte padding.
 * @return Right-aligned flag value (uint8_t). Bit 0 of result = first named bit.
 */
#define J2735_VERTICAL_ACCELERATION_THRESHOLD_GET(buf)                                             \
  J2735_INTERNAL_GET_ALL_VERTICAL_ACCELERATION_THRESHOLD(                                          \
      J2735_INTERNAL_RAW_READ_VERTICAL_ACCELERATION_THRESHOLD(buf))

/**
 * @brief Get notEquipped flag (ASN.1 bit 0).
 * @param[in] buf Pointer to VerticalAccelerationThreshold UPER encoding (const uint8_t*).
 * @pre @p buf must point to valid encoding with +7 byte padding.
 * @return 0 or 1.
 */
#define J2735_VERTICAL_ACCELERATION_THRESHOLD_GET_NOT_EQUIPPED(buf)                                \
  J2735_INTERNAL_GET_ONE_VERTICAL_ACCELERATION_THRESHOLD(                                          \
      J2735_INTERNAL_RAW_READ_VERTICAL_ACCELERATION_THRESHOLD(buf),                                \
      J2735_INTERNAL_BIT_VERTICAL_ACCELERATION_THRESHOLD_NOT_EQUIPPED)
 ...
 * @return 0 or 1.
 */
#define J2735_VERTICAL_ACCELERATION_THRESHOLD_GET_LEFT_FRONT(buf)                                  \
  J2735_INTERNAL_GET_ONE_VERTICAL_ACCELERATION_THRESHOLD(                                          \
      J2735_INTERNAL_RAW_READ_VERTICAL_ACCELERATION_THRESHOLD(buf),                                \
      J2735_INTERNAL_BIT_VERTICAL_ACCELERATION_THRESHOLD_LEFT_FRONT)
 ...
 * @return 0 or 1.
 */
#define J2735_VERTICAL_ACCELERATION_THRESHOLD_GET_LEFT_REAR(buf)                                   \
  J2735_INTERNAL_GET_ONE_VERTICAL_ACCELERATION_THRESHOLD(                                          \
      J2735_INTERNAL_RAW_READ_VERTICAL_ACCELERATION_THRESHOLD(buf),                                \
      J2735_INTERNAL_BIT_VERTICAL_ACCELERATION_THRESHOLD_LEFT_REAR)
 ...
 * @return 0 or 1.
 */
#define J2735_VERTICAL_ACCELERATION_THRESHOLD_GET_RIGHT_FRONT(buf)                                 \
  J2735_INTERNAL_GET_ONE_VERTICAL_ACCELERATION_THRESHOLD(                                          \
      J2735_INTERNAL_RAW_READ_VERTICAL_ACCELERATION_THRESHOLD(buf),                                \
      J2735_INTERNAL_BIT_VERTICAL_ACCELERATION_THRESHOLD_RIGHT_FRONT)
 ...
 * @return 0 or 1.
 */
#define J2735_VERTICAL_ACCELERATION_THRESHOLD_GET_RIGHT_REAR(buf)                                  \
  J2735_INTERNAL_GET_ONE_VERTICAL_ACCELERATION_THRESHOLD(                                          \
      J2735_INTERNAL_RAW_READ_VERTICAL_ACCELERATION_THRESHOLD(buf),                                \
      J2735_INTERNAL_BIT_VERTICAL_ACCELERATION_THRESHOLD_RIGHT_REAR)

#endif /* J2735_INTERNAL_DE_VERTICALACCELERATIONTHRESHOLD_H */
