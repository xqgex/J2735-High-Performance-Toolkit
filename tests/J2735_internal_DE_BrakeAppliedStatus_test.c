...
/**
 * @brief Test BrakeAppliedStatus with all flags OFF.
 *
 * @par ASN.1 Definition:
 * @code
 * BrakeAppliedStatus ::= BIT STRING {
 *     unavailable (0), leftFront (1), leftRear (2),
...
void test_brake_applied_status_all_zeros(void) {
  ...
  TEST_ASSERT_EQUAL_HEX8_MESSAGE(0x00U, J2735_BRAKE_APPLIED_STATUS_GET(payload),
                                 "All flags should be zero");
  TEST_ASSERT_EQUAL_UINT8_MESSAGE(0U, J2735_BRAKE_APPLIED_STATUS_GET_UNAVAILABLE(payload),
                                  "unavailable should be OFF");
  TEST_ASSERT_EQUAL_UINT8_MESSAGE(0U, J2735_BRAKE_APPLIED_STATUS_GET_LEFT_FRONT(payload),
                                  "leftFront should be OFF");
  TEST_ASSERT_EQUAL_UINT8_MESSAGE(0U, J2735_BRAKE_APPLIED_STATUS_GET_LEFT_REAR(payload),
                                  "leftRear should be OFF");
  TEST_ASSERT_EQUAL_UINT8_MESSAGE(0U, J2735_BRAKE_APPLIED_STATUS_GET_RIGHT_FRONT(payload),
                                  "rightFront should be OFF");
  TEST_ASSERT_EQUAL_UINT8_MESSAGE(0U, J2735_BRAKE_APPLIED_STATUS_GET_RIGHT_REAR(payload),
                                  "rightRear should be OFF");
}

/**
 * @brief Test BrakeAppliedStatus with all flags ON (0x1F).
 *
 * @par ASN.1 Definition:
 * @code
 * BrakeAppliedStatus ::= BIT STRING {
...
void test_brake_applied_status_all_ones(void) {
  ...
  TEST_ASSERT_EQUAL_HEX8_MESSAGE(0x1FU, J2735_BRAKE_APPLIED_STATUS_GET(payload),
                                 "All flags should be ON (0x1F)");
  TEST_ASSERT_EQUAL_UINT8_MESSAGE(1U, J2735_BRAKE_APPLIED_STATUS_GET_UNAVAILABLE(payload),
                                  "unavailable should be ON");
  TEST_ASSERT_EQUAL_UINT8_MESSAGE(1U, J2735_BRAKE_APPLIED_STATUS_GET_LEFT_FRONT(payload),
                                  "leftFront should be ON");
  TEST_ASSERT_EQUAL_UINT8_MESSAGE(1U, J2735_BRAKE_APPLIED_STATUS_GET_LEFT_REAR(payload),
                                  "leftRear should be ON");
  TEST_ASSERT_EQUAL_UINT8_MESSAGE(1U, J2735_BRAKE_APPLIED_STATUS_GET_RIGHT_FRONT(payload),
                                  "rightFront should be ON");
  TEST_ASSERT_EQUAL_UINT8_MESSAGE(1U, J2735_BRAKE_APPLIED_STATUS_GET_RIGHT_REAR(payload),
                                  "rightRear should be ON");
}

/**
 * @brief Test BrakeAppliedStatus with alternating pattern 10101 (0x15).
 *
 * @par Test Vector:
 * - unavailable(0): ON, leftFront(1): OFF, leftRear(2): ON,
...
void test_brake_applied_status_alternating_10101(void) {
  ...
  TEST_ASSERT_EQUAL_HEX8_MESSAGE(0x15U, J2735_BRAKE_APPLIED_STATUS_GET(payload),
...
/**
 * @brief Test BrakeAppliedStatus with alternating pattern 01010 (0x0A).
 *
 * @par Test Vector:
 * - unavailable(0): OFF, leftFront(1): ON, leftRear(2): OFF,
...
void test_brake_applied_status_alternating_01010(void) {
  ...
  TEST_ASSERT_EQUAL_HEX8_MESSAGE(0x0AU, J2735_BRAKE_APPLIED_STATUS_GET(payload),
...
/**
 * @brief Test BrakeAppliedStatus with only unavailable (bit 0) set.
 *
 * @par Test Vector:
...
void test_brake_applied_status_single_bit_unavailable(void) {
  ...
  TEST_ASSERT_EQUAL_HEX8_MESSAGE(0x10U, J2735_BRAKE_APPLIED_STATUS_GET(payload),
                                 "Only unavailable should be set (0x10)");
  TEST_ASSERT_EQUAL_UINT8_MESSAGE(1U, J2735_BRAKE_APPLIED_STATUS_GET_UNAVAILABLE(payload),
                                  "unavailable should be ON");
  TEST_ASSERT_EQUAL_UINT8_MESSAGE(0U, J2735_BRAKE_APPLIED_STATUS_GET_RIGHT_REAR(payload),
                                  "rightRear should be OFF");
...
/**
 * @brief Test BrakeAppliedStatus with only rightRear (bit 4) set.
 *
 * @par Test Vector:
...
void test_brake_applied_status_single_bit_right_rear(void) {
  ...
  TEST_ASSERT_EQUAL_HEX8_MESSAGE(0x01U, J2735_BRAKE_APPLIED_STATUS_GET(payload),
...
/**
 * @brief Test BrakeAppliedStatus SIZE macro returns fixed 5 bits.
 */
/* cppcheck-suppress misra-c2012-8.7 ; Unity RUN_TEST requires external linkage */
void test_brake_applied_status_size(void) {
  ...
  TEST_ASSERT_EQUAL_UINT32_MESSAGE(5U, J2735_BRAKE_APPLIED_STATUS_SIZE(payload),
                                   "SIZE should always be 5 for BrakeAppliedStatus");
}
...
/**
 * @brief Test BrakeAppliedStatus with deliberately misaligned buffer pointer.
 *
 * @par Test Vector:
 * - All 5 flags: ON (0x1F)
 *
...
void test_brake_applied_status_misaligned_access(void) {
  ...
  TEST_ASSERT_EQUAL_HEX8_MESSAGE(0x1FU, J2735_BRAKE_APPLIED_STATUS_GET(unaligned_ptr),
                                 "Misaligned: all flags should be ON (0x1F)");
  TEST_ASSERT_EQUAL_UINT8_MESSAGE(1U, J2735_BRAKE_APPLIED_STATUS_GET_UNAVAILABLE(unaligned_ptr),
                                  "Misaligned: unavailable should be ON");
  TEST_ASSERT_EQUAL_UINT8_MESSAGE(1U, J2735_BRAKE_APPLIED_STATUS_GET_RIGHT_REAR(unaligned_ptr),
...
/**
 * @brief Run all BrakeAppliedStatus tests.
 */
void run_testsuite_brake_applied_status(void) {
  RUN_TEST(test_brake_applied_status_all_zeros);
  RUN_TEST(test_brake_applied_status_all_ones);
  RUN_TEST(test_brake_applied_status_alternating_10101);
  RUN_TEST(test_brake_applied_status_alternating_01010);
