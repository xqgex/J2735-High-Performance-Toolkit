...
class TestRawReadGenerator(SpecLoadingTestBase):
    ...
    def test_extensible_type_reads_correct_bits(self) -> None:
        ...
        code = generate_bitstring_internal_raw_read("VehicleEventFlags", self.spec)
    ...
    def test_non_extensible_8bit_type(self) -> None:
        ...
        code = generate_bitstring_internal_raw_read("GNSSstatus", self.spec)
    ...
    def test_non_extensible_12bit_type(self) -> None:
        ...
        code = generate_bitstring_internal_raw_read("AllowedManeuvers", self.spec)
