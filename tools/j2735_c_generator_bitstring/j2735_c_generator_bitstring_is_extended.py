...
"""
J2735 BIT STRING Is Extended Generator.

Generates public C macro for checking if a BIT STRING is in extended form.

Pattern: J2735_{TYPE}_IS_EXTENDED(buf)
...
def generate_bitstring_is_extended(type_name: str, spec: J2735Specification) -> str:
    """Generate public C macro for checking extension state.
    ...
    Returns:
        C code with is_extended macro definition.
    ...
    Examples:
        ...
        >>> code = generate_bitstring_is_extended("VehicleEventFlags", spec)
        >>> "J2735_VEHICLE_EVENT_FLAGS_IS_EXTENDED" in code
        True
        >>> "J2735_INTERNAL_IS_EXTENSION_VEHICLE_EVENT_FLAGS" in code
        True
        >>> "J2735_INTERNAL_RAW_READ_VEHICLE_EVENT_FLAGS" in code
        True
    """
