...
"""
J2735 BIT STRING Internal Raw Read Generator.
...
def generate_bitstring_internal_raw_read(type_name: str, spec: J2735Specification) -> str:
    """Generate C macro for reading raw bits from buffer.
    ...
    Returns:
        C code with raw read macro definition.
    ...
    Examples:
        ...
        >>> code = generate_bitstring_internal_raw_read("VehicleEventFlags", spec)
        >>> "J2735_INTERNAL_RAW_READ_VEHICLE_EVENT_FLAGS" in code
        True
        >>> "J2735_READ_BITS" in code
        True
        >>> "22U" in code
        True
    """
