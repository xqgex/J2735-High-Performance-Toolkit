...
"""
J2735 BIT STRING Internal Extension Check Generator.
...
def generate_bitstring_internal_is_extension(type_name: str, spec: J2735Specification) -> str:
    """Generate C macro for checking extension bit.
    ...
    Returns:
        C code with extension check macro definition.
    ...
    Examples:
        ...
        >>> code = generate_bitstring_internal_is_extension("VehicleEventFlags", spec)
        >>> "J2735_INTERNAL_IS_EXTENSION_VEHICLE_EVENT_FLAGS" in code
        True
        >>> ">> 21U" in code
        True
    """
